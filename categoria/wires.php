...
<head>
	...
	<meta name="keywords" content="Wires, Новини, Wires категорія wires">
	<meta name="description" content="Категорія призначена, якщо у вас тема якої нема на сайті!">
	<title>Wires - Категорія Wires</title>
	...
	<main class="main-content">
		...
		<section class="container-fluid section active">
			<div class="header-menu">
				<h1 class="title-content">Категорія Wires</h1>
			...
			<?php
				...
				// в БД posts по категориям конкретная таблица 
				$categoria = R::findLike( 'posts', [ 'categoria' => [ 'Wires' ] ] );

				// вывод статьи по конкретной категории в переменной $categoria
				if ($categoria) {	
					foreach ($categoria as $posts){
						echo '	<div class="col-news">
								<img src="../file/'.$posts['image'].'" alt="wires">
									<div class="foreword">
