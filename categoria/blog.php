...
<head>
	...
	<meta name="keywords" content="Wires, Новини, Wires категорія блог, Блог, Блогінг, Blog, Bloging, Своє життя, Показати враження, Емоції">
	<meta name="description" content="Розкажи про своє життя, поділися емоціями та ділися корисною інормацією, адже люди вчаться один в одного, тому захоплюй своїх читачів!">
	<meta property="site_name" content="Wires">
	<meta property="type" content="website">
	<title>Wires - Категорія Блог</title>
...
<body>
	...
	<section class="container-fluid section active">
		<div class="header-menu">
			<h1 class="title-content">Категорія Блог</h1>
		...
		<?php
			...
			$categoria = R::findLike( 'posts', [ 'categoria' => [ 'блог' ] ] );

			if ($categoria) {	
				foreach ($categoria as $posts){
					echo '	<div class="col-news">
							<img src="../file/'.$posts['image'].'" alt="блог">
								<div class="foreword">
