...
<head>
	...
	<meta name="keywords" content="Wires, Новини, Wires категорія спорт, олімпіада, конкурс змагань, турнік, боротьба, тренування м'язів, розвиток м'язів, йога">
	<meta name="description" content="Здоров'я - це найголовніше, що є в людини, тому важливо дотримуватись фізичних рухів, розкажіть комплекси вправ для розвитку м'язів та розтяжки, розкажіть в чому користь коплексних вправв для людини. Можете розказати про свої досягнення в спорті, цікаві факти, а також свої тренування!">
	<title>Wires - Категория Спорт</title>
	...
	<main class="main-content">
		...
		<section class="container-fluid section active">
			<div class="header-menu">
				<h1 class="title-content">Категорія Спорт</h1>
			...
			<?php
				...
				$categoria = R::findLike( 'posts', [ 'categoria' => [ 'спорт' ] ] );

				if ($categoria) {	
					foreach ($categoria as $posts){
						echo '	<div class="col-news">
								<img src="../file/'.$posts['image'].'" alt="спорт">
									<div class="foreword">
