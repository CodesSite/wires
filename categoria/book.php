...
<head>
	...
	<meta name="keywords" content="Wires, Новини, Wires категорія книги, Книги, Нові книги, Рекомендовані книги, Книги на різні тематики, Порекомендувати книгу">
	<meta name="description" content="Знайди собі цікаву книгу з категорії. Покажи про свої враження про книгу, які емоції пережили, та цікаву догадку, яку можливо ніхто даже не замітив під час її прочитання!">
	<meta property="site_name" content="Wires">
	<meta property="type" content="website">
	<title>Wires - Категорія Книги</title>
...
<body>
	...
	<section class="container-fluid section active">
		<div class="header-menu">
			<h1 class="title-content">Категорія Книги</h1>
		...
		<?php
			...
			$categoria = R::findLike( 'posts', [ 'categoria' => [ 'книги' ] ] );

			if ($categoria) {	
				foreach ($categoria as $posts){
					echo '	<div class="col-news">
							<img src="../file/'.$posts['image'].'" alt="книга">
								<div class="foreword">
