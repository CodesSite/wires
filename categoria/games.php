...
<head>
	...
	<meta name="keywords" content="Wires, Новини, Wires категорія ігри, game, ігри <?php echo date('Y');?>, Рокстар, Сталкер 2">
	<meta name="description" content="Розкажи нову цікаву іноформацію про ігри, вони можуть включати як комп'ютерні так і настільні ігри!">
	<title>Wires - Категорія Ігри</title>
	...
	<main class="main-content">
		...
		<section class="container-fluid section active">
			<div class="header-menu">
				<h1 class="title-content">Категорія Ігри</h1>
			...
			<?php
				...
				$categoria = R::findLike( 'posts', [ 'categoria' => [ 'ігри' ] ] );

				if ($categoria) {	
					foreach ($categoria as $posts){
						echo '	<div class="col-news">
								<img src="../file/'.$posts['image'].'" alt="ігри">
									<div class="foreword">
