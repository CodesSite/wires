...
<head>
	...
	<meta name="keywords" content="Wires, Новини, Wires категорія проблема? відповідь!, як, чому, як зробити, вирішення проблем, допоможіть">
	<meta name="description" content="Ви змогли вирішати проблему, яку ніхто не зміг, ну що ж, рекомендуємо вам опублікувати її вирішення, оскільки ви допоможете багатьом людям уникати проблем наприклад з комп'ютерною технікою, працею на дачі або навіть розказати як ви зробили свій проєкт.">
	<title>Wires - Категорія Проблема? Відповідь!</title>
	...
	<main class="main-content">
		...
		<section class="container-fluid section active">
			<div class="header-menu">
				<h1 class="title-content">Категорія Проблема? Відповідь!</h1>
			...
			<?php
				...
				$categoria = R::findLike( 'posts', [ 'categoria' => [ 'проблема? відповідь!' ] ] );

				if ($categoria) {	
					foreach ($categoria as $posts){
						echo '	<div class="col-news">
								<img src="../file/'.$posts['image'].'" alt="проблема? відповідь!">
									<div class="foreword">
